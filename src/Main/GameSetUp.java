...
public class GameSetUp implements Runnable {
	...
	private void tick(){
		...
		//Hace que el juego entre al pause state *TIENE UN BUG*
		pauseButt++;
		
		if(handler.getKeyManager().pbutt && pauseButt >=30){
			pauseButt = 0;
		 ...
		 if(handler.getWorld().player.lenght<0) {

	        	handler.getWorld().player.lenght=0;
